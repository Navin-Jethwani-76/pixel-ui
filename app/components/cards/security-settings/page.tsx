...
export const CustomSettingComponent = ({
    item,
}: {
    item: SecuritySettingType;
}) => {
    return (
        <>
...
function SecuritySettings() {
    ...
    const Settings: SecuritySettingType[] = [
        {
            ...
            endContent: (
                <>
                    <div
                        className={`flex w-full flex-wrap items-center justify-end gap-6 ${maxWidth !== "100%" ? "" : "flex-nowrap w-auto"
                            }`}
                    >
    ...
    const CardInnerContent = () => {
        return (
            ...
            >
                <Card
                    className={`w-full p-2 ${maxWidth === "375px"
                            ? "max-w-[360px]"
                            : maxWidth === "768px"
                                ? "max-w-md"
                                : "max-w-lg"
