        ...
        return (
            <>
                ...
                >
                    <Card>
                        <CardBody
                            className={`flex flex-col items-center gap-2 w-full ${maxWidth === "375px" ? "max-w-[360px]" : "max-w-sm"
                                }`}
                        >
                            ...
                            <ScrollShadow className="w-full max-h-[450px]" hideScrollBar size={0}>
                                <RadioGroup
                                    className="w-full"
    ...
    <Card className="w-full max-w-md">
      <CardBody className="flex flex-col items-center gap-2">
        ...
        <RadioGroup className="w-full" description="Selected payment method can be changed at any time.">
          {RadioOptions.map((option, index) => {
            return (
              <CustomRadio key={index} value={option.title} Icon={${withIcons ? "option.icon" : `null`
