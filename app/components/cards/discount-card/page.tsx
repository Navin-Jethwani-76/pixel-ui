    ...
    return (
      ...
      >
        <Card className={`w-full max-w-xs max-h-[600px]`}>
          <CardBody
            className={`text-left subpixel-antialiased bg-gradient-to-br from-content1 to-default-100/50 ${
              selected ? "animate-flip-up" : "animate-flip-down"
            }`}
          >
            <div
              className={`flex justify-${
                selected ? "end" : "between"
              } gap-4 w-full`}
            >
              <>
